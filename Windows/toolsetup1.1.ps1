...
# Made by Logan Schultz, and Sam Brucker, and Claude
#Version | 1.1
#--------------------------------------------------------------
...
# Everthing
$urleverhing = "https://www.voidtools.com/Everything-1.4.1.1005.x64.zip"
$downloadPathever = "C:\Users\$env:USERNAME\Downloads\Everything-1.4.1.1005.x64.zip"
$extractPathever = "C:\voidtools"
...
# Create extract folder | EVERTHING
if (!(Test-Path $extractPathever)) {
    New-Item -ItemType Directory -Path $extractPathever | Out-Null
}
...
# Extract GitHub Repo
Expand-Archive -Path $downloadPathever -DestinationPath $extractPathever -Force 
...
Start-Process -FilePath "$extractPathSY\RAMMap.exe" -Verb RunAs
