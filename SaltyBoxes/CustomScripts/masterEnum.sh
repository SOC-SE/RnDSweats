...
# Force the locale to UTF-8 so the ● character is recognized
export LC_ALL=en_US.UTF-8
export LANG=en_US.UTF-8

# Force a dumb terminal to prevent color codes, but set a width
export TERM=dumb

# Tell systemctl not to use colors (redundancy for safety)
