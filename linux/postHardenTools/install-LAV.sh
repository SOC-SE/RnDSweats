#!/bin/bash
# linuxAVInstall.sh
# LMD & ClamAV installation with scheduled or real-time scanning
...
#   3 - Permission denied
#
# WARNING: RUNNING THIS SERVICE REAL-TIME IS VERY RESOURCE INTENSIVE. THIS WILL BE TOO MUCH FOR MOST 2GB LINUX SYSTEMS
#
